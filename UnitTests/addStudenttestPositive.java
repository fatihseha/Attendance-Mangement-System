...
public class addStudenttestPositive extends TestCase {
    ...
    public void testaddStudentPositive() throws IOException {


        String expected = main.StudentIDField.getText() + " added to the Lecture";
